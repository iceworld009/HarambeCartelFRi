...
public class AutoCloseRed extends OpMode {
    ...
    private final Pose scorePose1 = new Pose(64,95,Math.toRadians(90)); // scorePose 1 doar cu turreta
    private final Pose pickup1_3Pose = new Pose(63.1, 119.5, Math.toRadians(90)); // Highest (First Set) of Artifacts from the Spike Mark.
    private final Pose pickup2Pose = new Pose(78, 95   , Math.toRadians(90)); // Middle (Second Set) of Artifacts from the Spike Mark.
    private final Pose aux_2 = new Pose(82, 108   , Math.toRadians(90)); // Middle (Second Set) of Artifacts from the Spike Mark.
    private final Pose pickup2_3Pose = new Pose(85.5,123,Math.toRadians(90));
    private final Pose parkPose = new Pose(40.7, 91, 2.116); // Park // Park
    private final Pose unloadPose = new Pose(82.8,132.5,Math.toRadians(112));
    private final Pose unloadPose2 = new Pose(83.1,132.5,Math.toRadians(115));
    private final Pose aux = new Pose (82 , 108  , Math.toRadians(115));
    DcMotor FR , FL , BR , BL;
    double shoots = 0;
    ...
    void updateTurretFusion() {     //Odometrie instant + corectie limelight
        ...
        dy = HardwareClass.autoRedScorePoseY - y;
