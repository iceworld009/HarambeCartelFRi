...
public enum Color {
    ...
    public static Color getColor(double red, double green, double blue, double alpha, double red2, double green2, double blue2, double alpha2){
        red+=red2;
        green+=green2;
        blue+=blue2;
        alpha+=alpha2;
