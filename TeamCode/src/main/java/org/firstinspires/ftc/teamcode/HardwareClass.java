...
public class HardwareClass {
    ...
    public static double autoBlueScorePoseX=2, autoBlueScorePoseY=143, autoRedScorePoseX=142, autoRedScorePoseY=143, autoArtilleryScorePoseX, autoArtilleryScorePoseY;
